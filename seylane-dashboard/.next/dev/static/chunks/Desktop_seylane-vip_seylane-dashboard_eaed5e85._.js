...
"[project]/Desktop/seylane-vip/seylane-dashboard/components/dashboard/CoreSprite.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CoreSprite() {
    ...
    const springX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(pointerX, {
        stiffness: 110,
        damping: 18
    });
    const springY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$spring$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpring"])(pointerY, {
        stiffness: 110,
        damping: 18
    });
    const pupilX = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(springX, {
        "CoreSprite.useTransform[pupilX]": (value)=>value * 0.35
    }["CoreSprite.useTransform[pupilX]"]);
    const pupilY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$value$2f$use$2d$transform$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransform"])(springY, {
        "CoreSprite.useTransform[pupilY]": (value)=>value * 0.35
    }["CoreSprite.useTransform[pupilY]"]);
    const { t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$components$2f$providers$2f$language$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"])();
    const [isBlinking, setIsBlinking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoreSprite.useEffect": ()=>{
            const onMove = {
                "CoreSprite.useEffect.onMove": (event)=>{
                    const x = event.clientX / window.innerWidth * 2 - 1;
                    const y = event.clientY / window.innerHeight * 2 - 1;
                    pointerX.set(x * 30);
                    pointerY.set(y * 20);
                }
            }["CoreSprite.useEffect.onMove"];
            window.addEventListener('pointermove', onMove);
            return ({
                "CoreSprite.useEffect": ()=>window.removeEventListener('pointermove', onMove)
            })["CoreSprite.useEffect"];
        }
    }["CoreSprite.useEffect"], [
        pointerX,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoreSprite.useEffect": ()=>{
            const unsubscribes = [];
            modules.forEach({
                "CoreSprite.useEffect": (key)=>{
                    moduleSelectors[key].forEach({
                        "CoreSprite.useEffect": (selector)=>{
                            document.querySelectorAll(selector).forEach({
                                "CoreSprite.useEffect": (element)=>{
                                    const enter = {
                                        "CoreSprite.useEffect.enter": ()=>{
                                            setFocus(key);
            ...
            return ({
                "CoreSprite.useEffect": ()=>unsubscribes.forEach({
                        "CoreSprite.useEffect": (unsub)=>unsub()
                    }["CoreSprite.useEffect"])
            })["CoreSprite.useEffect"];
        }
    }["CoreSprite.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoreSprite.useEffect": ()=>{
            ...
            let blinkTimeout;
            const scheduleBlink = {
                "CoreSprite.useEffect.scheduleBlink": ()=>{
                    ...
                    blinkTimeout = setTimeout({
                        "CoreSprite.useEffect.scheduleBlink": ()=>{
                            ...
                            setIsBlinking(true);
                            setTimeout({
                                "CoreSprite.useEffect.scheduleBlink": ()=>setIsBlinking(false)
                            }["CoreSprite.useEffect.scheduleBlink"], 140);
                            scheduleBlink();
                        }
                    }["CoreSprite.useEffect.scheduleBlink"], delay);
                }
            }["CoreSprite.useEffect.scheduleBlink"];
            scheduleBlink();
            return ({
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                'left',
                                'right'
                            ].map((side)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CoreSprite, "aEa5MD8rbp1YgsXpBZzYJfeWaII=", false, function() {
    return [
...
_c = CoreSprite;
var _c;
__turbopack_context__.k.register(_c, "CoreSprite");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$components$2f$providers$2f$language$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/seylane-vip/seylane-dashboard/components/providers/language-provider.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$lib$2f$state$2f$language$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/seylane-vip/seylane-dashboard/lib/state/language-store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$components$2f$dashboard$2f$CoreSprite$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/seylane-vip/seylane-dashboard/components/dashboard/CoreSprite.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$seylane$2d$vip$2f$seylane$2d$dashboard$2f$components$2f$dashboard$2f$CoreSprite$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CoreSprite"], {}, void 0, false, {
                            fileName: "[project]/Desktop/seylane-vip/seylane-dashboard/components/os/sentinel-eye.tsx",
                            lineNumber: 119,
                            columnNumber: 11
                        }, this)
...
//# sourceMappingURL=Desktop_seylane-vip_seylane-dashboard_eaed5e85._.js.map